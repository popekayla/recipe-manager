function onLoad() {
   ...
   /*Chili Functions*/
    ...
    function hideSection(sectionName) {
         if(document.querySelector(sectionName).classList.contains("invisible")) {
            document.querySelector(sectionName).classList.remove("invisible");
            document.querySelector(sectionName).classList.add("visible");
        } else {
            document.querySelector(sectionName).classList.add("invisible");
            document.querySelector(sectionName).classList.remove("visible");
        }
    }
    document.querySelector("#hideChiliIngredients").onclick = hideSection("#chiliIngredients");
